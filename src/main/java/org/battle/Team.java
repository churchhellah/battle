...
public final class Team {
    ...
    public AbstractWarrior getAliveMember() {
        for (AbstractWarrior member : members) {
            if (member.isAlive()) {
                return member;
            }
        } return null;
